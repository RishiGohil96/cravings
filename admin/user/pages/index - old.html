    ...
    <body class="fix-header card-no-border fix-sidebar">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 align-self-center">
                            <h3 class="text-themecolor">Orders / Pending Orders</h3>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    where cravings_test_orders_details.order_status='placed'
        ...
        <script type="text/javascript">
            function order_details(order_no)
            {
                ...
                $.redirect("order_details.php",{order_no : order_no, order_status : 'pending'});
            }
        </script>
    </body>
